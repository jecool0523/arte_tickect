...
export const musicals: Record<string, MusicalInfo> = {  
  rent: {
    ...
    synopsis: `1989년 12월 24일, 뉴욕 이스트빌리지.
영화감독을 꿈꾸는 마크와 음악가 로저는 오래된 아파트 다락방에서 난방도 끊긴 채 새해를 맞는다.
그들의 친구였던 베니는 부잣집 딸과 결혼 후 건물주가 되어 로저와 마크에게 월세를 독촉한다.
\n
과거 연인 에이프릴의 죽음 이후 로저는 세상에 남길 단 한 곡의 노래를 찾으며 고독하게 살아간다.
그런 그의 앞에 댄서 미미가 나타나고, 얼어붙은 마음은 조금씩 흔들리기 시작한다.
\n
퍼포먼스 아티스트 모린과 그녀의 연인 조앤, 그리고 자유로운 영혼 엔젤과 철학적인 콜린스까지.
\n
이들은 각자의 방식으로 세상에 맞서고, 서로에게 기대며 하루하루를 버틴다.
가난과 병, 불안, 그리고 사랑 속에서.`,
